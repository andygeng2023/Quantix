...
<script>window.QUANTIX_PRICE=<?=json_encode($prices)?>;window.QUANTIX_FORECAST=<?=json_encode($metrics)?>;</script><script src="assets/js/stock.js"></script><?php require __DIR__.'/partials/footer.php'; ?>